...
1.  Ensure that your package successfully passes all
    ...
    `autotest`](https://ropensci-review-tools.github.io/autotest/).

2.  Decide which of our in-scope categories of statistical software best
    describe your package. The function
    [`srr_stats_categories()`](https://ropensci-review-tools.github.io/srr/reference/srr_stats_categories.html)
...
4.  Load the `srr` package and generate lists of standards within your
    ...
    [`srr_stats_roxygen(category = c("<my-category-1>", "<my-category-2>"))`](https://ropensci-review-tools.github.io/srr/reference/srr_stats_roxygen.html).
...
includes a function,
[`srr_stats_pkg_skeleton()`](https://ropensci-review-tools.github.io/srr/reference/srr_stats_pkg_skeleton.html),
