...
current working directory. Use of the package also requires a GitHub
authorization token to be stored in the local environment with a name of
either `GITHUB_TOKEN` or `GITHUB_PAT`. See
...
2.  Decide which of our in-scope categories of statistical software best
    ...
    [`srr_stats_categories()`](https://ropenscilabs.github.io/srr/reference/srr_stats_categories.html)
...
4.  Load the `srr` package and generate lists of standards within your
    ...
    [`srr_stats_roxygen(category = c("<my-category-1>", "<my-category-2>"))`](https://ropenscilabs.github.io/srr/reference/srr_stats_roxygen.html).
...
includes a function,
[`srr_stats_pkg_skeleton()`](https://ropenscilabs.github.io/srr/reference/srr_stats_pkg_skeleton.html),
