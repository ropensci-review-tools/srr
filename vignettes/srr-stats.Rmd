...
```
```{r skeleton-output, eval = FALSE, echo = FALSE, message = TRUE, collapse = TRUE}
roxygen2::roxygenise (d)
```
```{r roxygenize-fakey, echo = FALSE, eval = TRUE, collapse = TRUE}
cli::cli_text ("Writing NAMESPACE")
cli::cli_alert_info ("Loading package")
message ("")
txt <- "rOpenSci Statistical Software Standards"
cli::rule (center = cli::col_green (txt), line_col = "green")
cli::cli_h3 ("@srrstats standards (7 / 10):")
msgs <- c (
...
cli::cli_h3 ("@srrstatsNA standards (1 / 10):")
msg <- "[RE3.3] on line#5 of file [R/srr-stats-standards.R]"
message (paste0 ("  * ", msg, collapse = "\n"), sep = "")

cli::cli_h3 ("@srrstatsTODO standards (2 / 10):")
msgs <- c (
