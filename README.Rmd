...
Use of the package also requires a GitHub authorization token to be stored in
the local environment with a name of either `GITHUB_TOKEN` or `GITHUB_PAT`. See
