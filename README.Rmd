...
The first section provides explicit descriptions of how the functions of the `rssr`
package can help developers prepare packages for submission, while the second
section describes how the functionality of the package can aid reviewers in
assessing submitted packages. In both cases, the general procedures are
